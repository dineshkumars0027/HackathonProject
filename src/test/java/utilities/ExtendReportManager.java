...
public class ExtendReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Identify Courses"); // Title of report
		sparkReporter.config().setReportName("Identify Courses in Coursera"); // name of the report
